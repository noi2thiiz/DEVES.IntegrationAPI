...
namespace DEVES.IntegrationAPI.WebApi.Logic.Services.Tests
{
    ...
    public class CLSCreateCorporateClientTests
    {
        ...
        public string CreateCLSCorporateClientTest(string roleCode="G")
        {
            ...
            */
            ...
            Assert.AreEqual(false, string.IsNullOrEmpty(result?.data?.cleansingId), "cleansingId should not null or empty");
            return result.data.cleansingId;

        }

        [TestMethod()]
        public string Execute_CLSCreateGeneralCorporateClientTest()
        {
            var service = new CLSCreateCorporateClientService(Guid.NewGuid().ToString(), "UnitTest");
            var input = new CLSCreateCorporateClientInputModel
            {
