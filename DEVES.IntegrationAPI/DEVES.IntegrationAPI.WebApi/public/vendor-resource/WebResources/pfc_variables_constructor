function initvariable(){
    ...
    switch(hostname){
        ...
        case "crmdev.deves.co.th":
        case "crmappdev.deves.co.th":
            window.top.xrmApiRootPart = "https://crmappqa.deves.co.th/XrmApi/Api";
            window.top.internalApiRootPart = "https://crmappqa.deves.co.th/internal-service/api";
            window.top.callCenterLinkHostname = "http://192.168.10.33";
            window.top.callCenterLinkProxyPart = "https://crmappdev.deves.co.th/proxy/call-center-link.ashx";
            break;
        ...
        case "crmappqa.deves.co.th":
            ...
            window.top.internalApiRootPart = "https://crmappqa.deves.co.th/internal-service/api";
            window.top.callCenterLinkHostname= "http://192.168.10.33";
            window.top.callCenterLinkProxyPart = "https://crmappqa.deves.co.th/proxy/call-center-link.ashx";
        ...
        case "crmapp.deves.co.th":
            ...
            window.top.callCenterLinkProxyPart = "https://crmapp.deves.co.th/proxy/call-center-link-pro.ashx";

            break;
    }
    window.top.callCenterLinkPart = window.top.callCenterLinkHostname+"/NewProduct.asp?token=INi9SdhXRvpZO7mYI0ViUlflmqc9I9GO";
