...
public class proxy : IHttpHandler {
    ...
    private static string PROXY_REFERER = "";
    ...
    public void ProcessRequest(HttpContext context) {
        ...
        switch (uri)
        {    //=="CLS_InquiryCLSPersonalClient"
            case "CLS_InquiryCLSPersonalClient" :
                uri = "http://192.168.3.194/ServiceProxy/ClaimMotor/jsonproxy/CLS_InquiryCLSPersonalClient"; break;

            case "CLS_InquiryCLSCorporateClient":
                uri = "http://192.168.3.194/ServiceProxy/ClaimMotor/jsonproxy/CLS_InquiryCLSCorporateClient";break;

            case "COMP_InquiryClientMaster":
                uri = "http://192.168.3.194/ServiceProxy/ClaimMotor/jsonservice/COMP_InquiryClientMaster";break;

            case "COMP_SAPInquiryVendor":
                uri = "http://192.168.3.194/ServiceProxy/ClaimMotor/jsonproxy/COMP_SAPInquiryVendor";break;

            case "MOTOR_InquiryMasterASRH":
                uri = "http://192.168.3.194/ServiceProxy/ClaimMotor/jsonproxy/MOTOR_InquiryMasterASRH";break;

            case "CLIENT_UpdateCorporateClientAndAdditionalInfo":
                uri = "http://192.168.3.194/ServiceProxy/ClaimMotor/jsonservice/CLIENT_UpdateCorporateClientAndAdditionalInfo";break;

            case "CLIENT_CreateCorporateClientAndAdditionalInfo":
                uri = "http://192.168.3.194/ServiceProxy/ClaimMotor/jsonservice/CLIENT_CreateCorporateClientAndAdditionalInfo";break;

            case "CLIENT_CreatePersonalClientAndAdditionalInfo":
                uri = "http://192.168.3.194/ServiceProxy/ClaimMotor/jsonservice/CLIENT_CreatePersonalClientAndAdditionalInfo";break;

            case "COMP_SAPCreateVendor":
                uri = " http://192.168.3.194/ServiceProxy/ClaimMotor/jsonproxy/COMP_SAPCreateVendor";break;

            case "CLS_CreateCorporateClient":
                uri = "http://192.168.3.194/ServiceProxy/ClaimMotor/jsonproxy/CLS_CreateCorporateClient";break;
            case "CLS_CreatePersonalClient":
                uri = "http://192.168.3.194/ServiceProxy/ClaimMotor/jsonproxy/CLS_CreatePersonalClient";break;
