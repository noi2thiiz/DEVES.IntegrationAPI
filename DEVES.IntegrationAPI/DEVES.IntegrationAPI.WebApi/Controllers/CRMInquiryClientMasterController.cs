...
namespace DEVES.IntegrationAPI.WebApi.Controllers
{
...

    {
        public object Post([FromBody]object value)
        {
            ...
            inqClientCmd.TransactionId = GetTransactionId();
            ...
            var content =
                inqClientCmd.Execute(inqClientCmd.DeserializeJson<InquiryClientMasterInputModel>(value.ToString()));
            return Request.CreateResponse(content);
        }

        private static void GetValidateOutput(InquiryClientMasterOutputModel_Fail outputFail)
        {
