...
using DEVES.IntegrationAPI.Model.UpdateClaimStatus;
...
{
    public class UpdateClaimStatusController : ApiController
    {
        //To use with log
        private string _logImportantMessage;
        private readonly log4net.ILog _log = log4net.LogManager.GetLogger(typeof(UpdateClaimStatusController));
        ...
        public object Post([FromBody]object value)
        {
            ...
            var contentModel = JsonConvert.DeserializeObject<UpdateClaimStatusInputModel>(contentText);
        ...
        private EWIResponse HandleMessage(string valueText, UpdateClaimStatusInputModel content)
        {
            //TODO: Do what you want
            var output = new EWIResponse();
            var updateClaimStatusOutput = new UpdateClaimStatusOutputModel();
