...
public partial class SearchCustomer : System.Web.UI.Page
{
    ...
    protected void onBtnTest(object sender, EventArgs e)
    {
        ...
        string strRes = @"  var ResObj ={ callerpage:'createClient',data:{'cleansingId':'C2017-007852663','polisyClientId':'16961226','crmClientId':'201704-0000263','personalName':'test03','personalSurname':'003'}};
    ...
    protected void openCrmCreate(object sender, EventArgs e)
    {
        ...
        var popup = window.open('https://crmqa.deves.co.th/main.aspx?etc=10072&pagetype=entityrecord','_blank',options);";
