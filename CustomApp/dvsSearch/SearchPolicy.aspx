    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:DropDownList ID="ddlSearchView" runat="server" Width="200"
                ...
                <asp:ListItem Value="2" Text="เลขประจำตัวประชาชน"></asp:ListItem>
                <asp:ListItem Value="3" Text="เจ้าของกรมธรรม์"></asp:ListItem>
                <asp:ListItem Value="4" Text="เบอร์โทรศัพท์"></asp:ListItem>
                <asp:ListItem Value="5" Text="เลขทะเบียนรถ"></asp:ListItem>
                <asp:ListItem Value="6" Text="เลขตัวถัง"></asp:ListItem>
        ...
        <asp:GridView ID="gvCZID" AutoGenerateColumns="False" runat="server" Width="100%" PageSize="10"
            ...
            DataKeyNames="pfc_policy_additionalId" ShowHeader="true" CellPadding="-1" CssClass="gvCZID" HeaderStyle-BackColor="PaleTurquoise" EnableSortingAndPagingCallbacks="False">
