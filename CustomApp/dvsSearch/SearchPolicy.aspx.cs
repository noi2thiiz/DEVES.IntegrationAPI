...
public partial class SearchPolicy : System.Web.UI.Page
{
    ...
    private void ManaulSearch()
    {
        ...
        if (!string.IsNullOrEmpty(textSearch.Text.Trim()))
        {
            switch (typeSearch)
            {
                case 0: dt = QryInfo.QueryInfo_Policy(ParamsType.PolicyNo, textSearch.Text.Trim()); break;//Policy No
                case 1: dt = QryInfo.QueryInfo_Policy(ParamsType.CitezenId, textSearch.Text.Trim()); break;//Citizen ID
                case 2: dt = QryInfo.QueryInfo_Policy(ParamsType.CustomerName, textSearch.Text.Trim()); break;//Fullname
                case 3: dt = QryInfo.QueryInfo_Policy(ParamsType.Mobile, textSearch.Text.Trim()); break;//Mobile
                case 4: dt = QryInfo.QueryInfo_Policy(ParamsType.PlateNo, textSearch.Text.Trim()); break;//Plate Number
                case 5: dt = QryInfo.QueryInfo_Policy(ParamsType.ChassisNo, textSearch.Text.Trim()); break;//Chassis Number
                case 6: dt = QryInfo.QueryInfo_Policy(ParamsType.Barcode, textSearch.Text.Trim()); break;//Barcode 
                case 7: dt = QryInfo.QueryInfo_Policy(ParamsType.InsuranceCard, textSearch.Text.Trim()); break;//Insurance Card 
            }
