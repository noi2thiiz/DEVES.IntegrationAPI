<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchDriver.aspx.cs" Inherits="SearchDriver" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:DropDownList ID="ddlSearchView" runat="server" Width="200"
                AutoPostBack="true">
                <asp:ListItem Value="1" Text="Driver Name"></asp:ListItem>
        ...
        <asp:GridView ID="gvCZID" AutoGenerateColumns="false" runat="server" Width="100%"  AllowSorting="True" PageSize="10"
            ...
            DataKeyNames="ClientId" ShowHeader="true" CellPadding="-1" CssClass="gvCZID" HeaderStyle-BackColor="PaleTurquoise" OnSelectedIndexChanged="gvCZID_SelectedIndexChanged"
            >
