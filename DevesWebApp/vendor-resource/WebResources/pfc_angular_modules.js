...
function jBox(type, options) {
    ...
    if (this.options.preloadAudio === true && this.options.audio) {
        ...
        jQuery.each(this.options.audio, function (index, url) {
            this.options.preloadAudio.push(url + '');
...
jBox.prototype.audio = function (url, volume)
{
    ...
    if (!jBox._audio[url]) {
        ...
        jQuery('<source/>', {src: url + ''}).appendTo(audio);
        jQuery('<source/>', {src: url + ''}).appendTo(audio);
...
angular.module('app.core', [])
    .factory('dialog', [ '$rootScope', function ( $rootScope ) {
     ...
     // $("body").append('<div id="myModal" style="display: none"></div>');
        ...
        var self = {
            success: function(opt) {
                $rootScope.$evalAsync(function(){
                    ...
                    var myModal = new jBox('Modal',cfg );
                    myModal.open();
                });
            },
            error: function(opt) {
            ...
            confirm:function (opt) {
                var cfg = $.extend({
                    ...
                    height: 100,
                    title: 'Confirm',
                    content: '<i>Are you sure?</i>',
                 
                    confirmButton:"OK",
                    cancelButton:"Cancel"

                },opt)
                var myModal = new jBox('Confirm',cfg );
                myModal.open();
            }
        };
