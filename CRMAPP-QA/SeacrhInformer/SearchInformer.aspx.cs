...
using devesSearchInformer;


public partial class SearchInformer : System.Web.UI.Page
{
    ...
    private void openPageCRM(string CustomerName, string Primarykey)
    {
        ...
        string strRet = @"  var ResObj = new Object();
                                var InformerArray = new Array();
                                InformerArray[0] = '{0}';
                                InformerArray[1] = '{1}';
                                InformerArray[2] = 'contact';
                                

                                ResObj.new_informerid = InformerArray; 
