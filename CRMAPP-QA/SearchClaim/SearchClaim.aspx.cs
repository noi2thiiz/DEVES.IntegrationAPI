...
using devesSearchClaim;
using UpdateContactName;
...
public partial class SearchClaim : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (policyIdValue != null)
            {
                ...
                dt = QryInfo.QueryInfo_Contact(ParamsType.PolicyNo, policyIdValue);
    ...
    private void ManaulSearch()
    {
        ...
        if (!string.IsNullOrEmpty(textSearch.Text.Trim()))
        {
            switch (typeSearch)
            {
                case 0: dt = QryInfo.QueryInfo_Contact(ParamsType.ClaimNo, textSearch.Text.Trim()); break;//Claim No
                ...
                case 4: dt = QryInfo.QueryInfo_Contact(ParamsType.PolicyNo, textSearch.Text.Trim()); break;//PolicyNo
            }
