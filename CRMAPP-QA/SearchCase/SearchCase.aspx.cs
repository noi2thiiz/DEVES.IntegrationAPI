...
public partial class SearchCase : System.Web.UI.Page
{
    ...
    private void ManaulSearch()
    {
        ...
        if (!string.IsNullOrEmpty(textSearch.Text.Trim()))
        {
            switch (typeSearch)
            {
                case 0: dt = QryInfo.QueryInfo_Contact(ParamsType.CaseNo, textSearch.Text.Trim()); break;//Claim Number
                case 1: dt = QryInfo.QueryInfo_Contact(ParamsType.CustomerName, textSearch.Text.Trim()); break;//Customer Name
                ...
                case 4: dt = QryInfo.QueryInfo_Contact(ParamsType.ClaimNo, textSearch.Text.Trim()); break;//Claim Number
                case 5: dt = QryInfo.QueryInfo_Contact(ParamsType.PolicyNo, textSearch.Text.Trim()); break;//Policy Number
                case 6: dt = QryInfo.QueryInfo_Contact(ParamsType.DriverName, textSearch.Text.Trim()); break;//Driver Name
            }
