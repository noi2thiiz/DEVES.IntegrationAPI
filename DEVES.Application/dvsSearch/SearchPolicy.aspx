      ...
      <div class="col-xs-11">
        ...
        <div id="gridview">
            <asp:GridView ID="gvCZID" AutoGenerateColumns="false" runat="server" Width="100%"  AllowSorting="True"  PageSize="10"
                      ...
                      CssClass="table table-striped table-bordered table-hover " OnRowCommand="ProductsGridView_RowCommand" OnSelectedIndexChanged="gvCZID_SelectedIndexChanged1"
            >
...
<PagerSettings Visible="False" />
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Chdr Number" Visible="false">
                    <ItemTemplate>
                        <div style="margin-left: auto; margin-right: auto; text-align: center;">
                            <asp:Label ID="lbPNUMChdrnum" runat="server" Text='<%#Eval("pfc_chdr_num")  %>' />
                        </div>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Zren Number" Visible="false" >
                    <ItemTemplate>
                        <div style="margin-left: auto; margin-right: auto; text-align: center;">
                            <asp:Label ID="lbPNUMZrennum" runat="server" Text='<%#Eval("pfc_zren_num")  %>' />
                        </div>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Tran Number" Visible="false">
                    <ItemTemplate>
                        <div style="margin-left: auto; margin-right: auto; text-align: center;">
                            <asp:Label ID="lbPNUMTrannum" runat="server" Text='<%#Eval("pfc_tran_num")  %>' />
                        </div>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Rsk Number" Visible="false">
                    <ItemTemplate>
                        <div style="margin-left: auto; margin-right: auto; text-align: center;">
                            <asp:Label ID="lbPNUMRsknum" runat="server" Text='<%#Eval("pfc_rsk_num")  %>' />
                        </div>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Policy AdditionalId" Visible="false">
                    <ItemTemplate>
                        <div style="margin-left: auto; margin-right: auto; text-align: center;">
                            <asp:Label ID="lbPNUMAdditionalId" runat="server" Text='<%#Eval("pfc_policy_additionalId")  %>' />
                        </div>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Policy AdditionalId" Visible="false">
                    <ItemTemplate>
                        <div style="margin-left: auto; margin-right: auto; text-align: center;">
                            <asp:LinkButton id="myid" runat="server" Text='<%#Eval("pfc_policy_additionalId")  %>' />
                        </div>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="" >
                    <ItemTemplate>
                        <div style="margin-left: auto; margin-right: auto; text-align: center;">
                            <asp:HyperLink Target="_blank" id="hlDetails2" Text="Gen Page" Runat="server" 
                            NavigateUrl='<%# CallGenPage(Eval("pfc_chdr_num"),Eval("pfc_zren_num"),Eval("pfc_tran_num"),Eval("pfc_rsk_num"))%>' 
