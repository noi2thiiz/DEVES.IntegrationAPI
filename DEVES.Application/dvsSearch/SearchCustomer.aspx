...
<%--            <asp:Button  ID="btnNew"   runat="server" Text="New" OnClick="openCrmCreate" />--%>
          ...
          <div class="col-xs-11">
              ...
              <asp:RadioButtonList ID="radListClientType"  runat="server" RepeatDirection="Horizontal" Class="redio-container" OnSelectedIndexChanged="radListClientType_SelectedIndexChanged">
...
<%--            <asp:GridView ID="GridView1" AutoGenerateColumns="false" runat="server" Width="100%"  AllowSorting="True"  PageSize="10"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Policy Client ID">
                    <ItemTemplate>
                        <div style="margin-left: auto; margin-right: auto; text-align: center;">
                ...
                <asp:TemplateField HeaderText="CRM Person ID">
                    <ItemTemplate>
                        <div style="margin-left: auto; margin-right: auto; text-align: center;">
                            <asp:Label ID="lbCZIDCRMCientID" runat="server" Text='<%#Eval("CRMCientID")  %>' />
                        </div>
                    </ItemTemplate>
                </asp:TemplateField>
