...
public partial class SearchCustomer : System.Web.UI.Page
{
    ...
    public class ParamsType
    {
        ...
        public static string CZIDID = "CZID_ID";
    ...
    const string _const_Search_Client_Corporate = "Corporate"; //radListSearchSource.SelectedValue
    ...
    private void openPageCRM(string CustomerName, string Primarykey ,string ContactType ,string ContactType2)
    {
        ...
        string strRet = @"  var ResObj = new Object();
                                ...
                                ResObj.new_incustomerid = CustomerArray;
    ...
    protected void openCrmCreate(object sender, EventArgs e)
    {
        string strRes = @" 
        var w =screen.width; h = screen.height-150;
        var options = 'width='+w+',height='+h+'directories=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no';
        var popup = window.open('https://crmqa.deves.co.th/main.aspx?etc=10053&pagetype=entityrecord','_blank',options);";
        strRes += @" console.log('receiveMessage');
    ...
    protected void radListClientType_SelectedIndexChanged(object sender, EventArgs e)
    {
